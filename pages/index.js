      ...
      <main className=' bg-gradient-to-b from-primary via-blue-900 to-secondary'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 text-white pl-10  md:pl-0'>
          ...
          <div className='sm:col-span-2'>
            ...
            <span className='absolute sm:top-72 sm:left-96 sm:ml-16 sm:mt-24 top-96 mt-52 left-0 '>
              <Image
                src='/hero3.png'
                alt='image'
                height={160}
            ...
            <span className='absolute sm:top-96 sm:mt-5 sm:ml-48 sm:left-96 bottom-0 left-28'>
              <button
                disabled='disabled'
